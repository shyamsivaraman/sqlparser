...
public class GroupedExprElement implements QueryElement_I {

	private String m_SqlPart;
	private QueryElement_I m_Parent;
	
	public GroupedExprElement(String part, QueryElement_I parent) {
	...
	public void accept(QueryVisitor_I visitor) throws ParseException {
		List<String> subParts = ParserHelper.getInstance().generateWhereClauseParts(m_SqlPart);
